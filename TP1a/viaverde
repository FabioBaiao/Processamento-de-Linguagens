...
function printFooter(file, active){
	footer_fmt = "<div class='footer'> <a target='_blank' href='http://www.viaverde.pt'><img class='viaverde' src='%s'/></a>";
	switch (active){
		case 1: 
	...
	print "<div class='foot_label'><p style='color:#4CAF50'>Via Verde</p>" > file;
	print "<p style='font-size:small'>Parar para quê?</p></div></div></body></html>" > file;
}
