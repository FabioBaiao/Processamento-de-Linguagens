...
\textbf{Todas as transações de serviços oferecidos pela ViaVerde (portagens, parques de estacionamento, etc), sendo que cada transação tem campos como: data e horas de entrada e saída, local de entrada e saída, valor, etc:}
...
Aqui foi tomada a decisão de escolher como \textit{field separator} os caracteres \textless\space e \textgreater.
